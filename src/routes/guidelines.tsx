...
export const Route = createFileRoute("/guidelines")({
  head: () => ({
    meta: [
      { title: "Community Guidelines — Krew3" },
      {
        name: "description",
        content: "How we keep Krew3 a good place to build, learn and ship together.",
      },
    ],
  }),
...
const guidelines = [
  ...
  {
    title: "Be inclusive.",
    copy: "The Krew is for everyone who builds — regardless of background, experience level, or stack.",
  },
];
  ...
  return (
    <>
      <PageHero label="Community Guidelines" title="How we treat each other.">
        Krew3 works because people respect each other. Here's what we expect.
      </PageHero>
        ...
        <div className="max-w-3xl space-y-10">
          ...
          <div className="pt-4">
            <p className="text-base text-muted-foreground">
              These guidelines apply everywhere in Krew3 — posts, events, DMs, and comments. If
              something doesn't feel right, let us know.
            </p>
