...
export const Route = createFileRoute("/x-card-test")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.krew3.site/x-card-test" },
    ...
    links: [{ rel: "canonical", href: "https://www.krew3.site/x-card-test" }],
  }),
...
function XCardTestPage() {
  return (
    <div className="mx-auto w-full max-w-2xl px-4 pt-16 sm:px-6 lg:px-8">
      <h1 className="text-2xl font-semibold">X card test</h1>
      <p className="mt-3 text-muted-foreground">Temporary route for link-preview diagnostics.</p>
      <Link
        to="/venues"
        className="label-mono mt-6 inline-flex items-center text-primary underline-offset-4 hover:underline"
      >
        Back to Venues
      </Link>
    </div>
